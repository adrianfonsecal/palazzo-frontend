  ...
  const events = [
    {
      ...
      description: 'Acompña a los novios en la ceremonia de boda en la catedral histórica de San Lorenzo.',
      icon: <Church className="h-6 w-6" />
    },
    {
      time: '5:00 PM',
      title: 'Hora de la Cena',
      description: 'Celebra con botellas de champagne y un exquisito menú italiano en el grand ballroom.',
      icon: <PartyPopper className="h-6 w-6" />
    },
    {
      time: '7:00 PM',
      title: 'Hora de la gran fiesta',
      description: 'Una fiesta elegante, con música y baile hasta la medianoche.',
      icon: <UtensilsCrossed className="h-6 w-6" />
    },
    {
      time: '11:00 PM',
      title: 'Hora del After Party',
      description: 'Continua la fiesta con cócteles, postres y baile bajo la luna en el patio.',
  ...
  return (
    <section className="relative min-h-screen bg-background py-24 md:py-32">
      ...
      <div className="mx-auto max-w-4xl px-6">
        ...
        >
          <p className="text-sm font-medium uppercase tracking-[0.3em] text-primary">La Celebración</p>
          <h2 className="mt-4 font-serif text-4xl md:text-5xl lg:text-6xl text-foreground">Nuestro Día</h2>
