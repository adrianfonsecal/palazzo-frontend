import CeremonySection from "@/app/(guest)/invitacion/[uuid]/components/wedding/CeremonySection";
import DressCodeSection from "@/app/(guest)/invitacion/[uuid]/components/wedding/DressCodeSection";
import FooterSection from "@/app/(guest)/invitacion/[uuid]/components/wedding/FooterSection";
import HeroSection from "@/app/(guest)/invitacion/[uuid]/components/wedding/HeroSection";
import ItinerarySection from "@/app/(guest)/invitacion/[uuid]/components/wedding/ItinerarySection";
import LodgingSection from "@/app/(guest)/invitacion/[uuid]/components/wedding/LodgingSection";
import PhotoUploadSection from "@/app/(guest)/invitacion/[uuid]/components/wedding/PhotoUploadSection";
import RSVPSection from "@/app/(guest)/invitacion/[uuid]/components/wedding/RSVPSection";
