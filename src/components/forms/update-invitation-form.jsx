...
export default function UpdateInvitationForm({ onSuccess, data }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await updateInvitationByUuid( uuid, payload);
            
            onSuccess(); 
        } catch (err) {
            console.error(err);
            setError('Error al actualizar la invitación. Verifica los datos.');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="pt-2">
                ...
                >
                    {loading ? 'Actualizando...' : 'Actualizar Invitación'}
                </button>
            </div>
        </form>
    );
